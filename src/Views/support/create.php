...
<div style="max-width:700px;">
    <nav style="font-size:13px;color:var(--text-2);margin-bottom:18px;">
        ...
        <span style="color:var(--text-1);">Nuevo articulo</span>
    </nav>

    <h1 style="color:var(--text-1);font-size:22px;font-weight:600;margin-bottom:20px;">Nuevo articulo</h1>
    ...
    <?php if (empty($categories)): ?>
        <div style="background:var(--bg-surface);border:1px solid var(--border);border-radius:8px;padding:24px;">
            <h2 style="font-size:16px;color:var(--text-1);font-weight:600;margin-bottom:8px;">Primero crea una seccion</h2>
            <p style="font-size:14px;color:var(--text-2);line-height:1.6;margin-bottom:18px;">
                Para cargar un articulo, la base de conocimiento necesita al menos una seccion donde organizarlo.
            </p>
            <div style="display:flex;gap:10px;">
                ...
                <a href="<?= base('soporte') ?>"
                    style="background:transparent;border:1px solid var(--border-2);color:var(--text-2);font-size:13px;padding:8px 14px;border-radius:6px;text-decoration:none;">
                    Volver
                </a>
            </div>
        </div>
    <?php else: ?>
    <form method="POST" action="<?= base('soporte') ?>" enctype="multipart/form-data"
        ...
        <div>
            ...
            <textarea name="body" id="support-body" style="display:none;"></textarea>
        ...
        <div>
            <label style="display:block;font-size:12px;color:var(--text-2);margin-bottom:5px;">Adjuntos</label>
            ...
            <p style="font-size:12px;color:var(--text-3);margin-top:6px;">PDF, Office e imagenes. Maximo 10MB por archivo.</p>
